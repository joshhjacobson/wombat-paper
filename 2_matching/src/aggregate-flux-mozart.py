...
from mozart.grid import MOZART_GRID
...
parser = argparse.ArgumentParser(
    description="""
Aggregate MOZART fluxes to monthly.
"""
)
...
def aggregate_run(run):
    ...
    output["longitude_width"] = MOZART_GRID["longitude"]["widths"]
    output["latitude_height"] = MOZART_GRID["latitude"]["widths"]
