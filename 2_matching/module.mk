...
$(GEOS_CHEM_MATCHED_RUNS_LAST_COMBINED): $(2_MATCHING_SOURCE)/combine.R $(GEOS_CHEM_MATCHED_RUNS_LAST_COMPUTED_XCO2) $(GEOS_CHEM_MATCHED_RUNS_LAST_SUBSETTED)
	Rscript $< \
		--matched-runs-directory $(GEOS_CHEM_MATCHED_RUNS)
	touch $@

$(GEOS_CHEM_MATCHED_RUNS_LAST_COMPUTED_XCO2_3HR): $(2_MATCHING_SOURCE)/compute-xco2-3hr.R
	Rscript $< \
...
$(GEOS_CHEM_MATCHED_RUNS_LAST_COMPUTED_XCO2): $(2_MATCHING_SOURCE)/compute-xco2.R $(GEOS_CHEM_MATCHED_RUNS_LAST_SUBSETTED)
	Rscript $< \
